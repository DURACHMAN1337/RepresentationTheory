...
import static LinearSpace.SlnC.*;

public class LinearSpaceSlnC {
    public static int dim = 4; //размерность алгебры Sl
    public static SlnC slnC = new SlnC();
    public static ArrayList<int[][]> matricesH = slnC.generateMatricesH(dim); // Генерируем матрицы h
    public static ArrayList<int[][]> matricesE = slnC.generateMatricesE(dim); // Генерируем матрицы e
    public static ArrayList<GeomVector> vectorsA = generateVectorsA(matricesH, matricesE); // Генерируем Векторы a
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-----------------Матрицы  e-----------------");
                printListOfMatrices(matricesE);
